...
def main(argv):
    ...
    for one_truth_file in allTruthText:
        a = one_truth_file.strip().split("/")
        lang = [ lang for lang in langs if lang in one_truth_file]
        ...
        clean_train_data_lower_case = []
        for each_line in clean_train_data:
        	lower_case_clean_train_data = lower_case_clean_train_data.append(each_line.lower())

        clean_train_data = lower_case_clean_train_data
